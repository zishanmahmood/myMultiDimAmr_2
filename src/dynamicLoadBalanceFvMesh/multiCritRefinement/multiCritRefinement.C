...
bool Foam::multiCritRefinement::readMultiCritRefinementDict()
{
    ...
    nBufferLayers_ = readLabel(dynamicMeshDict.subDict("dynamicMultiDimRefineFvMeshCoeffs").lookup("nBufferLayers"));
    ...
    if( dynamicMeshDict.isDict("multiCritRefinementControls") )
    {
        ...
        if( enableMultiCritRefinementControl_ )
        {
            ...
            // Overwrite field name entry in dynamicMultiDimRefineFvMeshCoeffs?
...
void Foam::multiCritRefinement::updateRefinementField()
{
    ...
    (
        ...
        ).subDict("dynamicMultiDimRefineFvMeshCoeffs")
    );
